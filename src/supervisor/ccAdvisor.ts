...
export function createSupervisorCcAdvisorFromEnv(
  ...
  const provider = normalizeConfigValue(readSymHarixEnv('SYMPHONY_SUPERVISOR_CC_PROVIDER'))
  ...
  const model = normalizeConfigValue(readSymHarixEnv('SYMPHONY_SUPERVISOR_CC_MODEL'))
  ...
  const apiKey = normalizeConfigValue(readSymHarixEnv('SYMPHONY_SUPERVISOR_CC_API_KEY'))
  ...
  const baseUrl = normalizeConfigValue(readSymHarixEnv('SYMPHONY_SUPERVISOR_CC_BASE_URL'))
    ...
    ?? (normalizedProvider === 'anthropic'
      ...
      : normalizedProvider === 'openai'
        ...
        : null);
  const timeoutMs = parsePositiveInteger(readSymHarixEnv('SYMPHONY_SUPERVISOR_CC_TIMEOUT_MS'))
