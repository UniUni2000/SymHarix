...
**Architecture:** 
- 在现有 Symphony 项目 (`/home/agent/symharix`) 基础上扩展
...
**项目前提:**
- 基础 Symphony 项目已在 `/home/agent/symharix` 
...
```bash
# Copy Claude Code runtime modules to symharix
cp -r /home/agent/cc-haha/src/entrypoints /home/agent/symharix/src/claude-code/
cp -r /home/agent/cc-haha/src/services /home/agent/symharix/src/claude-code/services/
```
