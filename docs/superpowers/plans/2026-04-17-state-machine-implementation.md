...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_state_machine.py -v`
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_state_store.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_config.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_linear_client.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_github_client.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_retry.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_cli.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_hooks_dev.py -v`
Expected: FAIL - module not found
...
Run: `cd /Users/example/projects/symharix && python -m pytest scripts/__tests__/test_hooks_review.py -v`
Expected: FAIL - module not found
