...
**日期**: 2026-04-20
**状态**: Draft
**关联设计**: [2026-04-20-symphony-cloud-e2e-design.md](/Users/liupenghui/Documents/code/agent/test-cc/docs/2026-04-20-symphony-cloud-e2e-design.md)
...
- [src/orchestrator/index.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/orchestrator/index.ts)
- [src/workspace/manager.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/workspace/manager.ts)
- [src/database/schema.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/database/schema.ts)
- [src/server/index.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/server/index.ts)
...
- [src/database/repositories/index.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/database/repositories/index.ts)
  统一导出新仓储

### 5.2 Workspace 层

将当前 [src/workspace/manager.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/workspace/manager.ts) 拆分为：
...
- [src/github/issue-client.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/github/issue-client.ts)
- [scripts/lib/github_client.py](/Users/liupenghui/Documents/code/agent/test-cc/scripts/lib/github_client.py)
...
- 更新 [src/database/schema.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/database/schema.ts)
- 新增 repository 文件
- 补 repository 单测
...
现有 [src/server/index.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/server/index.ts) 可以继续保留 `tasks` 路由，新增 `work-items` 路由作为新控制面视图。
