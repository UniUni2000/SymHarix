...
当前 [src/workspace/manager.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/workspace/manager.ts) 已经有 git worktree 能力，但仍混杂了 repo clone、branch 删除、path fallback 等逻辑。后续应重构为两层：
...
当前 [src/database/schema.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/database/schema.ts) 里的 `tasks / workspaces / issue_tracking / review_history / audit_log` 还不够承载完整控制面。建议引入以下主表。
...
- [src/orchestrator/index.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/orchestrator/index.ts) 的控制面主循环
- [src/workspace/manager.ts](/Users/liupenghui/Documents/code/agent/test-cc/src/workspace/manager.ts) 的 worktree 基础能力
- [scripts/lib/github_client.py](/Users/liupenghui/Documents/code/agent/test-cc/scripts/lib/github_client.py) 的 PR/review 操作能力
